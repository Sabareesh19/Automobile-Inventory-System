...
/* Displays top trending products in the application based on the number of items sold,reviewrating and zipcode */
...
public class Trending extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		All the products information are dispalyed in the Content Section
		...
		//Mostsold by zip code
        while(itr1.hasNext()) {
         	Mostsoldzip mostzip = (Mostsoldzip)itr1.next();
	 		pw.print("<tr>");
			pw.println("<td border: 1px style='width: 94%'>");			
