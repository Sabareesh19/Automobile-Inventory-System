...
/* DataVisualization class is used by the StoreManager to view the products sold at each zipcode */
...
public class DataVisualization extends HttpServlet {
    ...
    /* Displays graph with y-axis as Zipcode and X-axis as products Sold */
