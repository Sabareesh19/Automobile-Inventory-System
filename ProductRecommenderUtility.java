...
/* ProductRecomender java file is used to put the list of products recomended to the user from the output.csv file */
...
public class ProductRecommenderUtility{	
	...
	public HashMap<String,String> readOutputFile(){
		...
		try 
		{
            ...
            br = new BufferedReader(new FileReader(new File(TOMCAT_HOME+"\\webapps\\Automobile_Inventory\\output.csv")));
	...
	// get productdetails from MySQL based on ID
