...
/* 
	Accessory class contains class variables name,price,image,retailer,condition,discount,quantity,manufacturerRebate.

	Accessory class has a constructor with Arguments name,price,image,retailer,condition,discount,quantity,manufacturerRebate.
	  
	Accessory class contains getters and setters for name,price,image,retailer,condition,discount,quantity,manufacturerRebate.
