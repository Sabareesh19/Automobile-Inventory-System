...
/* DealMatchesUtilities class is used to display the matched deals on the home page by connecting to the twitter Server */
...
public class DealMatchesUtilities extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{				
				...
				pw.print("<a href='#'>Welcome to Automobile Inventory </a></h2>");				
				pw.print("<div class='entry'>");
				pw.print("<img src='images/site/Automobilecart.jpg' style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
				pw.print("<br> <br>");
				pw.print("<h2>The world trusts us to deliver SPEEDY service....</h2>");
				pw.print("<br> <br>");
				pw.print("<h1 style='color: #0ca935 !important'>We beat our competitors in all aspects. Price-Match Guaranteed</h2>");				
				String line=null;
				String TOMCAT_HOME = System.getProperty("catalina.home");

				/* Gets the ProductDetails by connecting to the Twitter Server */
				...
				{					
					...
					{	
						/* Reads the DealMatches.txt file generated by the AutomobileInventoryDealMatch python file by getting tweats from the Twitter Server */

						BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\Automobile_Inventory\\DealMatches.txt")));
						...
						{	
							do {						      
								  ...
								  {								 
									pw.print("<h2 style='font-size: 20px;'>"+line+"</h2>");
									pw.print("<br>");
