...
/* Carousel class is used to implements carousel feature. It displays recomended products for an user */
...
public class Carousel{			
	public String  carouselfeature(Utilities utility){				
		...
		/* Displays list of recomended products based on user-usersimilarity */
